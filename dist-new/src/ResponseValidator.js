...
export class ResponseValidator {
    constructor(settings, MetadataServiceCtor = (settings) => new MetadataService(settings), UserInfoServiceCtor = (settings) => new UserInfoService(settings), joseUtil = JoseUtil, TokenClientCtor = TokenClient) {
        if (!settings) {
