...
describe("State", function () {
    ...
    describe("constructor", function () {
        ...
        it("should use date.now for created", () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe("clearStaleState", function () {
        it("should remove old state entries", function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield State.clearStaleState(store, 100);
